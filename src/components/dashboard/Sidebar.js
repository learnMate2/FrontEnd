...
import { FaChevronLeft, FaChevronRight, FaHome, FaQuestionCircle, FaFolder, FaBookOpen } from 'react-icons/fa';
...
const SideBar = () => {
  ...
  const items = [
    ...
    { text: 'Request a career counseling', icon: <GrUserManager />, link: '/dashboard/career-counseling' },
