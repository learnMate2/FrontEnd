      ...
      <Row className="py-5">
        ...
        <Col xs={12} md={3} className="text-white">
          ...
          <div className="quick_link">
            ...
            <Link to='/privacy-policy' className='quick_links'><FaLongArrowAltRight style={{marginRight:"5px"}}/> privacy policy</Link>
            <Link to='/terms' className='quick_links'><FaLongArrowAltRight style={{marginRight:"5px"}}/> Terms & Conditions</Link>
          </div>
        </Col>
        <Col xs={12} md={3} className="text-white">
